...
const PackageStatistic = (smallestYear: any) => {
    ...
    const { data: curPackageSend, isLoading: isLoading } = useGetList('exchangingDelivery', { filter: filter });
    const { data: curPackageReceive, isLoading: isLoading1 } = useGetList('exchangingDelivery', { filter: filter1 });

    const { data: curPackageFail, isLoading: isLoading2 } = useGetList('exchangingDelivery', { filter: filter2 });
    const { data: curPackageSending, isLoading: isLoading3 } = useGetList('exchangingDelivery', { filter: filter3 });
